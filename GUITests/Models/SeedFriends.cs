    ...
    public static class SeedFriends
    {
        public static List<Friend> GetSeed()
        {
            return new List<Friend>() { 
                ...
                new Friend() { Name = "James Fisher", Age = 30, Company="D’Ieteren", DateOfBirth = new DateTime(1980,2,20), PostalCode = "5000", Sex = Gender.Men, Weight=101},
                ...
                new Friend() { Name = "Thomas Segour", Age = 54, Company="KBC Bank", DateOfBirth = new DateTime(1970,10,12), PostalCode = "1000", Sex = Gender.Other, Weight=160} ,
            };
        }
    }
}
